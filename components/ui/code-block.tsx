...
export const CodeBlock: FC<CodeBlockProps> = memo(({ language, value, onFinishContractDeploy }) => {
  ...
  return (
    <div className={cn("codeblock flex flex-col w-full rounded-lg my-4 dark:bg-zinc-950 bg-gray-200")}>
      <div
        className={cn(
      ...
      >
        ...
        <div className="flex items-center space-x-1">
          {language === "clarity" && (
            <DeployContractButton getSourceCode={() => value} onFinishContractDeploy={onFinishContractDeploy} />
          )}
          <Button
            variant="ghost"
